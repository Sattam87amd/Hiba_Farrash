...
const WhatToExpectUser = () => {
  ...
  return (
    <div className="bg-white md:px-28 px-8 md:py-10">
      ...
      <div className="bg-[#F8F7F3] rounded-2xl p-6 md:px-16 flex flex-col md:flex-row items-start md:items-center md:justify-center gap-6 mb-3">
...
export default WhatToExpectUser;
