    ...
    <div>
      ...
      >
        ...
        <div className="w-full md:w-[50%] relative h-[60vh] md:h-screen overflow-hidden flex items-center justify-center mr-0 md:mr-10 mb-0 md:mb-0 mt-4 md:mt-0  md:px-0">
          <div className="relative md:-ml-32 w-full h-full max-h-[60vh] md:max-h-none mx-2 md:mx-0">
            <Image
       ...
       {/* Arabic Text on Right - Mobile Center, Desktop Right */}
        <div
          className="w-full md:w-[50%] flex flex-col justify-center items-center md:items-end mt-8 md:mt-0 p-4 md:p-12 z-10"
          dir="rtl"
        >
          <h3 className="text-5xl sm:text-2xl md:text-7xl font-rpt-Bold text-black text-center md:text-right leading-normal uppercase md:mb-7 font-black w-full md:max-w-none md:pr-0" 
              style={{ fontWeight: '900' }}>
            لمسة تدوم من
          </h3>

          <h1
            className="text-5xl sm:text-3xl md:text-7xl font-rpt-Bold text-black text-center md:text-right leading-normal uppercase mb-4 font-black w-full md:max-w-none"
            style={{
          ...
          <p className="text-xl sm:text-lg md:text-3xl font-rpt-Bold text-black uppercase leading-normal text-center md:text-right mb-6 md:mt-10 md:mb-20 max-w-lg md:max-w-none px-2 md:px-0 font-black w-full"
             style={{ fontWeight: '900' }}>
          ...
          <div className="w-full flex md:ml-24 justify-center md:justify-end mt-4 -mb-6 md:mt-0">
