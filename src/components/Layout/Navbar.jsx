    ...
    <div className="relative">
      <nav className={`fixed w-full z-50 top-0 h-20 md:h-24 bg-white -b -gray-200 `}>
        <div className={`max-w-[1280px] mx-auto flex items-center justify-between h-full px-4 md:px-8 `}>
          ...
          <div className={`hidden md:flex justify-center flex-grow items-center gap-8 text-[16px] font-medium `}>
            <button onClick={handleExpertRedirect} className="text-black hover:text-gray-700 transition" type="button">Become an Expert</button>
            <Link href="/ourmission" className="text-black hover:text-gray-700 transition">About</Link>
            <button onClick={toggleSearchPage} className="text-black hover:text-gray-700 p-2" type="button" aria-label="Search">
          ...
          <div className={`md:hidden flex items-center $`}>
            <button onClick={toggleMenu} className="text-black p-2" type="button" aria-label={isOpen ? "Close menu" : "Open menu"}>
